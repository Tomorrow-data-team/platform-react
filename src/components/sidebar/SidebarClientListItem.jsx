...
const Item = styled(ListItemButton)`
  padding-top: ${(props) =>
    props.theme.spacing(props.depth && props.depth > 0 ? 4 : 3)};
...
const SidebarClientListItem = (props) => {
  const {
    id,
    title,
    href,
  ...
  const handleLink = (e) => {
    setClient({clientId:id, clientName:title})
    setOpen(false);
  };
...
export default SidebarClientListItem;
