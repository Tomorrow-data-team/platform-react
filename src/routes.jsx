...
import UcidList from "./pages/Portal/ucid/Index";
import ClientSettings from "./pages/Portal/ClientSettings/ClientSettings"
...
import AllClientSettings from "./pages/utils/clients/clients";
import YoutubeSearch from "./pages/utils/youtube/youtube";
...
import BSI from "./pages/Portal/BSI/Index";
import BQdetails from "./pages/Portal/ClientSettings/BQ";
import Looker from "./pages/Portal/ClientSettings/Looker";
// Landing
...
import UcidAll from "./pages/Portal/ucid/UcidAll";
import Dashboard from "./pages/Portal/Default";
import Dash from "./pages/Portal/Dash/Dash";
...
const routes = [
  {
    ...
    children: [
      ...
      {
        path:"settings/bigquery",
        element: <BigQuery />
      },
      {
        path:"settings/looker",
        element: <Looker />
      },
      {
